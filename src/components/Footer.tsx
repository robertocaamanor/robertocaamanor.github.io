        ...
        <div className="grid md:grid-cols-3 gap-8">
          <div>
            ...
            <p className="footer-text leading-relaxed">
              {personalInfo.description.footer}
            </p>
          </div>
          ...
          <div>
            <h4 className="text-lg font-semibold mb-4">{footerContent.connectWith}</h4>
        ...
        <div className="border-t border-gray-800 dark:border-gray-900 mt-12 pt-8">
          <div className="flex justify-between items-center">
            ...
            <button
              ...
              className="text-sm footer-text hover:text-white transition-colors flex items-center gap-2"
            >
              {isAuthenticated ? (
                <>
