    ...
    <footer className="footer-section text-white py-12 transition-colors duration-200">
      <div className="container mx-auto px-6">
        <div className="grid md:grid-cols-3 gap-8">
          <div>
            <h3 className="text-2xl font-bold mb-4">Roberto Caamaño</h3>
          ...
          <div>
            ...
            <div className="flex gap-4">
              <a 
                href="https://instagram.com/rabertcaamano" 
                className="bg-gray-800 dark:bg-gray-900 p-3 rounded-lg hover:bg-gray-700 dark:hover:bg-gray-800 transition-colors"
              ...
              <a 
                href="https://www.linkedin.com/in/robertocaamanor" 
                className="bg-gray-800 dark:bg-gray-900 p-3 rounded-lg hover:bg-gray-700 dark:hover:bg-gray-800 transition-colors"
                aria-label="LinkedIn"
              >
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a 
                href="https://github.com/robertocaamanor" 
                className="bg-gray-800 dark:bg-gray-900 p-3 rounded-lg hover:bg-gray-700 dark:hover:bg-gray-800 transition-colors"
                aria-label="GitHub"
              >
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="border-t border-gray-800 dark:border-gray-900 mt-12 pt-8 text-center">
          <p className="footer-text">
            © 2025 Roberto Caamaño. Todos los derechos reservados.
          </p>
        </div>
      </div>
    </footer>
